...
label <- c(2^2, 2^3, 2^4, 2^5,2^6, 2^7, 2^8, 2^9, 2^10, 2^11, 2^12, 2^13, 2^14, 2^15)
plot(log_abs[1,1:14], col = "orange", type = "b", xaxt = "n", xlab = ("N"~(log[2]~"scale")), ylab = (log[10]~("Absolute Error")), pch=16, lwd = 4)
axis(1, at = 1:14, labels = label, las = 2)
...
label <- c(2^2, 2^3, 2^4, 2^5,2^6, 2^7, 2^8, 2^9, 2^10, 2^11, 2^12, 2^13, 2^14, 2^15)
plot(log_rel[5,1:14], col = "red", type = "b", xaxt = "n", xlab = ("N"~(log[2]~"scale")), ylab = (log[10]~("Relative Error")), pch=16, lwd = 4)
axis(1, at = 1:14, labels = label, las = 2)
...
legend(12, 0.25, legend=c("p = 0.50", "p = 0.25", "p = 0.10", "p = 0.05", "p = 0.01"),
       col=c("orange", "purple", "green", "blue", "red"), lty=1:2, cex=1, 
       title="p value", text.font=4, bg='lightblue')
