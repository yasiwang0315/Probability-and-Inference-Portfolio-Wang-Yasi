...
b <- matrix(nrow = 100, ncol = 32)

for(i in seq(1, 32)){
  for(j in seq_along(walk_out_money)){
    b[j, i] <- one_series(B= 10 * i, W = 300, L = 1000, M = 200) %>% get_last
  }
}
...
for(i in seq(1, 32)){
  for(j in seq_along(walk_out_money)){
    w[j, i] <- one_series(B= 200, W = 20 * i, L = 1000, M = 200) %>% get_last
  }
}
...
df2["Winning_threshold"] <- seq(20,640,20)
df2 %>%
