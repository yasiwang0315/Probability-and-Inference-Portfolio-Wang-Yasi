...
### 1. In Figure 1, I demonstrate the example of the evolvement of grambler earnings  over a series of wagers at the roulette wheel.

```{r}
# Q1
set.seed(2)
earning <- one_series(B = 200, W = 300, L = 1000, M = 100) - 200
plot(earning, main = "Figure 1: Gamblers earnings / losses over time", xlab = "play number", 
     ylab = "earnings", type ="b")
```
