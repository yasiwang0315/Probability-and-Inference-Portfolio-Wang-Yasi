...
# Quant
# plot(roots, mix3.mid.lengths)

# Requirement 2
#Density
 #plot(df3(roots),mix3.mid.lengths)
```
...
# Quant
# plot(roots, mix4.mid.lengths)

# Requirement 2
#Density
# plot(df4(roots),mix4.mid.lengths)
```
...
```{r}
plot(df3(roots),mix3.mid.lengths, xlab = "Density", ylab = "Length", main = "Length of middle 95% of the sampling distribution by density")
```
In this graph, the trend for the change of length is still hard to captured. This is probably due to the complexity of the mixture distribution.

### 4.4 Second mixture distribution
```{r}
plot(df4(roots),mix4.mid.lengths, xlab = "Density", ylab = "Length", main = "Length of middle 95% of the sampling distribution by density")
```
